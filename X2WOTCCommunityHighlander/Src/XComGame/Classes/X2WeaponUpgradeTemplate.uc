...
var array<name> UpgradeCats; // Issue #260 - may be used to indicate categories this upgrade is intended for, to be used with CanApplyUpgradeToWeapon or CanWeaponApplyUpgrade
